 ...
 */
final class Version20260303232220 extends AbstractMigration
{
    ...
    {
        // 1. Rename the table safely
        $this->addSql('RENAME TABLE `user` TO users');
        
        // 2. Add audit columns to the renamed table
        $this->addSql('ALTER TABLE users ADD created_by_id BINARY(16) DEFAULT NULL, ADD updated_by_id BINARY(16) DEFAULT NULL');
