 ...
 */
final class Version20260303232740 extends AbstractMigration
{
    ...
    {
        // 1. Rename table back to singular
        $this->addSql('RENAME TABLE users TO `user`');

        // 2. Make created_by_id NOT NULL in user (after we populated it)
        $this->addSql('ALTER TABLE `user` CHANGE created_by_id created_by_id BINARY(16) NOT NULL');
        
        // 3. Update FKs for user (renamed from users)
        ...
        $this->addSql('ALTER TABLE course CHANGE created_by_id created_by_id BINARY(16) NOT NULL');
        ...
        $this->addSql('ALTER TABLE module CHANGE created_by_id created_by_id BINARY(16) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course DROP FOREIGN KEY FK_169E6FB9B03A8386');
        $this->addSql('ALTER TABLE course DROP FOREIGN KEY FK_169E6FB9896DBBDE');
        $this->addSql('ALTER TABLE course CHANGE created_by_id created_by_id BINARY(16) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE module DROP FOREIGN KEY FK_C242628B03A8386');
        $this->addSql('ALTER TABLE module DROP FOREIGN KEY FK_C242628896DBBDE');
        $this->addSql('ALTER TABLE module CHANGE created_by_id created_by_id BINARY(16) DEFAULT NULL');
