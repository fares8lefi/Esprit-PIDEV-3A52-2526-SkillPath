 ...
 */
final class Version20260223221505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_cours DROP FOREIGN KEY `FK_73CC7484591CC992`');
        $this->addSql('ALTER TABLE user_cours DROP FOREIGN KEY `FK_73CC7484A76ED395`');
        ...
        $this->addSql('ALTER TABLE module ADD scheduled_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_cours (user_id INT NOT NULL, cours_id INT NOT NULL, INDEX IDX_73CC7484591CC992 (cours_id), INDEX IDX_73CC7484A76ED395 (user_id), PRIMARY KEY (user_id, cours_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE module DROP scheduled_at');
